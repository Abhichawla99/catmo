...
export function UnicornHero() {
    useEffect(() => {
        ...
        if (document.querySelector('script[src*="unicornStudio"]')) return;
    ...
    `;
                ...
                containers.forEach(container => {
                    ...
                    allElements.forEach(el => {
                        ...
                        if (
                            ...
                            el.setAttribute('style', 'display: none !important; visibility: hidden !important; opacity: 0 !important;');
        ...
        return () => {
            ...
            // Clean up script only if we want to re-load it, but usually standard is fine to leave or manage carefully.
            // For now, let's leave the global script as it might be used elsewhere or caching is fine.
