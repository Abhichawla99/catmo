...
const projects = [
    {
        ...
        description: "Scaling high-end eCommerce to 3000% ROAS.",
        gradient: "from-purple-600 via-violet-600 to-indigo-600",
        accentGradient: "from-purple-400/20 via-violet-500/30 to-indigo-500/20",
        link: "/case-studies-manuv/luxury-fashion-retailer"
    },
    {
        title: "Cleanfiniti",
        description: "Global Google Ads strategy and scaling.",
        gradient: "from-blue-600 via-cyan-600 to-teal-600",
        accentGradient: "from-blue-400/20 via-cyan-500/30 to-teal-500/20",
        link: "/case-studies-manuv/cleanfiniti-google-ads"
    }
];
